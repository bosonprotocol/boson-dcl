...
export class DescriptionPage {
    ...
    constructor(_kiosk: Kiosk, _parent: Entity, _productData: any) {
        ...
        this.greyTab.addComponent(new Transform({
        ...
        this.backButtonEntity.addComponent(new Transform({
            position: new Vector3(-1.2, 0.95, -0.002),
            rotation: Quaternion.Euler(180, 180, 0),
            scale: new Vector3(0.07, 0.07, 0.01),
        }))
        this.backButtonEntity.addComponent(new OnPointerDown(() => {
            // Left align product title
            if (this.kiosk.productPage != undefined) {
                this.kiosk.productPage.productName.getComponent(Transform).position.x = -1
                this.kiosk.productPage.productName.getComponent(TextShape).hTextAlign = "left"
            }
            this.hide()
            if(this.kiosk.productPage!=undefined && this.kiosk.productPage.lockComponent!=undefined){
        ...
        this.backButtonTexture = new Texture("images/UI/backArrow.png", { hasAlpha: true })
        ...
        this.tab1.addComponent(new Transform({
        ...
        this.tab1ClickBox.addComponent(new Transform({
            scale: new Vector3(5.2, 1, 1)
        }))
        this.tab1ClickBox.addComponent(Kiosk.alphaMat as Material)
        this.tab1ClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.tab2.addComponent(new Transform({
        ...
        this.tab2ClickBox.addComponent(new Transform({
            scale: new Vector3(5, 1, 1)
        }))
        this.tab2ClickBox.addComponent(Kiosk.alphaMat as Material)
        this.tab2ClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.tab3.addComponent(new Transform({
        ...
        this.tab3ClickBox.addComponent(new Transform({
            scale: new Vector3(5.5, 1, 1)
        }))
        this.tab3ClickBox.addComponent(Kiosk.alphaMat as Material)
        this.tab3ClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.tabUnderline.addComponent(new Transform({
        ...
        this.productDescriptionTitle.addComponent(new Transform({
        ...
        this.productDataInfoText = new TextShape(this.productData.metadata.product.description)
        ...
        this.productDataInfo.addComponent(new Transform({
        ...
        //// About the creator page ////
        this.aboutTheCreatorTitleText = new TextShape("About the artist - " + this.productData.metadata.product.productV1Seller.name)
        ...
        this.aboutTheCreatorTitle.addComponent(new Transform({
            position: new Vector3(-1.18, 0.55, -0.004),
            scale: new Vector3(0.1, 0.1, 0.1),
            rotation: Quaternion.Euler(0, 0, 0)
        }))
        ...
        this.aboutTheCreatorTextInfo = new TextShape(Helper.addNewLinesInString(this.productData.metadata.product.productV1Seller.description,75))
        ...
        this.aboutTheCreatorInfo.addComponent(new Transform({
            position: new Vector3(-1.18, 0.35, -0.004),
            scale: new Vector3(0.1, 0.1, 0.1),
            rotation: Quaternion.Euler(0, 0, 0)
        }))
        ...
        this.ShippingAndInventoryTitle.addComponent(this.ShippingAndInventoryTitleText)
        this.ShippingAndInventoryTitle.setParent(this.parent)
        this.ShippingAndInventoryTitle.addComponent(new Transform({
            position: new Vector3(-1.18, 0.55, -0.004),
            scale: new Vector3(0.1, 0.1, 0.1),
            rotation: Quaternion.Euler(0, 0, 0)
        }))
        ...
        this.ShippingAndInventoryInfoText = new TextShape("Initial stock: " + this.productData.quantityInitial+"\n"+"Available stock: " + this.productData.quantityAvailable)
        ...
        this.ShippingAndInventoryInfo.addComponent(this.ShippingAndInventoryInfoText)
        this.ShippingAndInventoryInfo.setParent(this.parent)
        this.ShippingAndInventoryInfo.addComponent(new Transform({
        ...
        this.ShippingAndInventoryShippingTitleText = new TextShape("Shipping information")
        ...
        this.ShippingAndInventoryShippingTitle.addComponent(this.ShippingAndInventoryShippingTitleText)
        this.ShippingAndInventoryShippingTitle.setParent(this.parent)
        this.ShippingAndInventoryShippingTitle.addComponent(new Transform({
        ...
        let shippingText:string = "Once redeemed expect a 2-4 week delivery worldwide\nfree shipping.\nTaxes & import duties are included in the price.\n\n\n"

        this.productData.metadata.shipping.supportedJurisdictions.forEach((shipping: { label: string, deliveryTime: string }) => {
        ...
        this.ShippingAndInventoryShippingInfo.addComponent(this.ShippingAndInventoryShippingInfoText)
        this.ShippingAndInventoryShippingInfo.setParent(this.parent)
        this.ShippingAndInventoryShippingInfo.addComponent(new Transform({
    ...
    public updateStock(_intialStock:number, _currentStock:number){
        if(this.ShippingAndInventoryInfoText!=undefined){
            this.ShippingAndInventoryInfoText.value = "Initial stock: " + _intialStock +"\n"+"Available stock: " + _currentStock
        }
    }
    ...
    public show() {
        ...
        if (this.kiosk.productPage != undefined) {
            ...
            this.kiosk.productPage.productName.getComponent(TextShape).hTextAlign = "center"
        }
    ...
    private moveUnderLineToTab(_tabnumber: number) {
        if (_tabnumber == 1) {
            this.tabUnderline.getComponent(Transform).position = new Vector3(-0.9, 0.752, -0.004)
        } else if (_tabnumber == 2) {
            this.tabUnderline.getComponent(Transform).position = new Vector3(-0.2, 0.752, -0.004)
        } else if (_tabnumber == 3) {
            this.tabUnderline.getComponent(Transform).position = new Vector3(0.5, 0.752, -0.004)
        }
    }
