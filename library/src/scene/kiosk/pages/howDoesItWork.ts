...
export class HowDoesItWork {
    ...
    constructor(_kiosk: Kiosk, _parent: Entity) {
        ...
        let backgroundScale: number = 1.65
        this.backgroundImageEntity.addComponent(new PlaneShape())
        this.backgroundImageEntity.setParent(this.parent)
        this.backgroundImageEntity.addComponent(new Transform({
            position: new Vector3(0, 0, -0.03),
            rotation: Quaternion.Euler(180, 180, 0),
            scale: new Vector3(1.543 * backgroundScale, 0.972 * backgroundScale, 0.1),
        }))

        this.backgroundImageMat = new Material()
        this.backgroundImageTexture = new Texture("images/UI/HowDoesItWork.jpg", { hasAlpha: false })
        ...
        this.learnMoreClickBox.addComponent(new Transform({
        ...
        this.learnMoreClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.etherScanLinkClickBox.addComponent(new Transform({
        ...
        this.etherScanLinkClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.openSeaLinkClickBox.addComponent(new Transform({
            position: new Vector3(0.01,0.13,-0.032),
            scale: new Vector3(0.75, 0.5, 0.01)
        }))

        this.openSeaLinkClickBox.addComponent(Kiosk.alphaMat as Material)
        this.openSeaLinkClickBox.addComponent(new OnPointerDown(() => {
        ...
        this.redeemLinkClickBox.addComponent(new Transform({
            position: new Vector3(0.83,0.13,-0.032),
            scale: new Vector3(0.75, 0.5, 0.01)
        }))

        this.redeemLinkClickBox.addComponent(Kiosk.alphaMat as Material)
        this.redeemLinkClickBox.addComponent(new OnPointerDown(() => {
