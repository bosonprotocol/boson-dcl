...
export class LockScreen {
    ...
    constructor(_kiosk: Kiosk, _productData: any) {
        ...
        this.backGroundTexture = new Texture("images/UI/widget_background.png", { hasAlpha: true })
        ...
        this.closeButtonTexture = new Texture("images/UI/closeBtn.png", { hasAlpha: true })
        ...
        this.productItemType.addComponent(new Transform({
            position: new Vector3(0, 1.05, 0),
            scale: new Vector3(0.1, 0.1, 0.1)
        }))
        
        this.productItemTypeText = new TextShape(this.productData.metadata.product.offerCategory + " ITEM")
        ...
        this.lockLogoEntity.addComponent(new Transform({
            position: new Vector3(0, -0.9, 0),
            rotation: Quaternion.Euler(180, 180, 0),
        ...
        this.lockLogoTexture = new Texture("images/UI/lockLogo.png", { hasAlpha: true })
        ...
        this.whiteBoxEntity.addComponent(new Transform({
        ...
        this.proceedButtonEntity.addComponent(new Transform({
            position: new Vector3(-0.226, -0.1, -0.002),
            rotation: Quaternion.Euler(180, 180, 0),
            scale: new Vector3(0.775 / 1.7, 0.224 / 1.7, 0.01),
        }))
        this.proceedButtonEntity.addComponent(new OnPointerDown(() => {
            this.hide()
            this.kiosk.showProduct(this.productData)
        }))

        this.proceedButtonMat = new Material()
        this.proceedButtonTexture = new Texture("images/UI/Proceed.png", { hasAlpha: false })
        ...
        this.productDollarPriceText.fontSize = 18
        ...
        this.productDollarPrice.addComponent(new Transform({
            position: new Vector3(0.05, 0.45, -0.002),
            scale: new Vector3(0.05, 0.05, 0.05),
            rotation: Quaternion.Euler(0, 0, 0)
        }))
        ...
        this.gateInfo.addComponent(new Transform({
