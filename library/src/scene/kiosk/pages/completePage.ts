...
export class CompletePage {
    ...
    constructor(_kiosk:Kiosk, _parent:Entity, _productData: any){
        ...
        // Success title
        this.successTitleText = new TextShape("You have successfully committed to this item and will receive an NFT\nVoucher that can be transferred, sold or used to redeem the item.")
        ...
        this.successTitle.addComponent(new Transform({
        ...
        this.errorTitle.addComponent(new Transform({
        ...
        this.htrEntity.addComponent(new Transform({
        ...
        this.htrTexture = new Texture("images/UI/HoldTransferRedeem.png", { hasAlpha: false })
        ...
        this.successEntity.addComponent(new Transform({
        ...
        this.successTexture = new Texture("images/UI/transactionSuccess.png", { hasAlpha: true })
        ...
        this.errorEntity.addComponent(new Transform({
            position: new Vector3(0, 0.55, -0.0085),
            rotation: Quaternion.Euler(180, 180, 0),
        ...
        this.errorTexture = new Texture("images/UI/transactionError.png", { hasAlpha: true })
