...
export class Variation {
    ...
    constructor(_offerID:number, _offerUUID:string, _initialStock:number, _availableStock:number, _option1:Option, _option2:Option){
...
export class VariationComponent {
    ...
    currentVariation:Variation = new Variation(-1,"",-1,-1,new Option("","",""),new Option("","","")) // Blank intialisation
    ...
    option1VariationIndex: number = 0
    option2VariationIndex: number = 0
    ...
    // UI
    constructor(_kiosk:Kiosk, _transform:Transform, _parent:Entity){
       this.kiosk = _kiosk

       this.variationPrevMat = new Material()
       this.variationPrevTexture = new Texture("images/UI/prevOption.png", { hasAlpha: true })
       ...
       this.variationNextTexture = new Texture("images/UI/nextOption.png", { hasAlpha: true })
       ...
       this.option1VariationPrevEntity.addComponent(new Transform({
           position: new Vector3(0.1+0.07, 0.44, -0.002),
           rotation: Quaternion.Euler(180, 180, 0),
           scale: new Vector3(0.04, 0.04, 0.01),
       }))
       this.option1VariationPrevEntity.addComponent(new OnPointerDown(()=>{
       ...
       this.option1VariationNextEntity.addComponent(new Transform({
           position: new Vector3(0.45, 0.44, -0.002),
           rotation: Quaternion.Euler(180, 180, 0),
           scale: new Vector3(0.04, 0.04, 0.01),
       }))
       this.option1VariationNextEntity.addComponent(new OnPointerDown(()=>{
           this.option1Next()
       },{
           hoverText: "Next"
       }))
       ...
       this.option1VariationOptionName.addComponent(this.option1VariationOptionNameText)
       this.option1VariationOptionName.setParent(_parent)
       this.option1VariationOptionName.addComponent(new Transform({
       ...
       this.option1VariationTypeName.addComponent(this.option1VariationTypeNameText)
       this.option1VariationTypeName.setParent(_parent)
       this.option1VariationTypeName.addComponent(new Transform({
       ...
       this.option2VariationPrevEntity.addComponent(new Transform({
           position: new Vector3(0.67, 0.44, -0.002),
           rotation: Quaternion.Euler(180, 180, 0),
           scale: new Vector3(0.04, 0.04, 0.01),
       }))
       this.option2VariationPrevEntity.addComponent(new OnPointerDown(()=>{
       ...
       this.option2VariationNextEntity.addComponent(new Transform({
           position: new Vector3(0.95, 0.44, -0.002),
           rotation: Quaternion.Euler(180, 180, 0),
           scale: new Vector3(0.04, 0.04, 0.01),
       }))
       this.option2VariationNextEntity.addComponent(new OnPointerDown(()=>{
           this.option2Next()
       },{
           hoverText: "Next"
       }))
       ...
       this.option2VariationOptionName.addComponent(this.option2VariationOptionNameText)
       this.option2VariationOptionName.setParent(_parent)
       this.option2VariationOptionName.addComponent(new Transform({
       ...
       this.option2VariationTypeName.addComponent(this.option2VariationTypeNameText)
       this.option2VariationTypeName.setParent(_parent)
       this.option2VariationTypeName.addComponent(new Transform({
       ...
       this.debugName.addComponent(new Transform({
    ...
    setValues(opionChanged:number){
        ...
        this.currentVariation.option1 = this.uniqueOption1[this.option1VariationIndex]
        this.filterOption2()

        // set option on current variation by index
        this.currentVariation.option2 = this.filteredOption2[this.option2VariationIndex]
        ...
        this.kiosk.productPage?.updateStock(variation.initialStock as number,variation.availableStock as number)
    ...
    private setImageArrowVisibility(){
        ...
        if(this.option1VariationIndex == 0){
            Helper.hideAllEntities([
                this.option1VariationPrevEntity
            ])
        } else {
        ...
        if(this.option1VariationIndex >= this.uniqueOption1.length-1){
            Helper.hideAllEntities([
                this.option1VariationNextEntity
            ])
        } else {
            Helper.showAllEntities([
                this.option1VariationNextEntity
        ...
        if(this.option2VariationIndex == 0){
            Helper.hideAllEntities([
                this.option2VariationPrevEntity
            ])
        } else {
            Helper.showAllEntities([
                this.option2VariationPrevEntity
        ...
        if(this.option2VariationIndex >= this.filteredOption2.length-1){
            Helper.hideAllEntities([
                this.option2VariationNextEntity
            ])
        } else {
            Helper.showAllEntities([
                this.option2VariationNextEntity
